...
function JsonApiResponder(schema) {
  return function(action, actionResult) {
    ...
    function handleGet(resultGraph) {
      ...
      const allIncluded = Object.assign({}, allData, {
        [rootType]: utils_1.omitKeys(allData[rootType] || {}, roots.map(r => r.id)),
      });
